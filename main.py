    ...
    <div class="container">
                        ...
                        <div class="card-body">
                            <form>
                                <div class="mb-3">
                                    ...
                                    <div id="emailHelp" class="form-text">Напиши свое имя, пж))
                                    </div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3 form-check">
                                    ...
                                    <label class="form-check-label"
                                           for="exampleCheck1">Напомни мой пароль, у меня
                                        лапки))</label>
                                </div>
        ...
        <div class="row mt-3">
            <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
                    data-bs-target="#collapseExample_1" aria-expanded="false"
        ...
        <div class="row mt-0">
            <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
                    data-bs-target="#collapseExample_2" aria-expanded="false"
        ...
        <div class="row mt-0">
            <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
                    data-bs-target="#collapseExample_3" aria-expanded="false"
